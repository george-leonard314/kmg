...
export const newNotebook = () => {
    ...
    <div class="b3-list--background fn__none" data-type="import-options" style="padding-top: 8px">
        <label class="b3-list-item fn__pointer" data-type="import-sy"><svg class="b3-list-item__graphic"><use xlink:href="#iconSiYuan"></use></svg><span class="b3-list-item__text">KMG .sy.zip</span><input class="b3-form__upload" type="file" accept="application/zip"></label>
