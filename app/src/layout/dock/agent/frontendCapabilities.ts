...
registerCapability({
    ...
    title: "Open settings",
    description: "Open KMG settings and optionally filter settings by a search query.",
...
registerCapability({
    ...
    title: "Open document",
    description: "Open a KMG document by its block ID in the current app.",
    inputSchema: {type: "object", properties: {id: {type: "string"}}, required: ["id"], additionalProperties: false},
    source: "native",
    handler: async (args, app) => {
        const id = args.id as string | undefined;
...
registerCapability({
    ...
    title: "Open search",
    description: "Open the KMG search interface and optionally fill in a query.",
    inputSchema: {type: "object", properties: {query: {type: "string"}}, additionalProperties: false},
    source: "native",
    handler: async (args, app) => {
        const query = (args.query as string | undefined)?.trim();
...
registerCapability({
    id: "native/frontend/open_setting",
    title: "Open settings",
    description: "Open KMG settings and optionally provide a search query.",
    inputSchema: {type: "object", properties: {query: {type: "string"}}, additionalProperties: false},
    source: "native",
    handler: async (args, app) => {
        const query = (args.query as string | undefined)?.trim();
...
registerCapability({
    id: "native/frontend/open_document",
    title: "Open document",
    description: "Open a KMG document by its block ID in the mobile app.",
    inputSchema: {type: "object", properties: {id: {type: "string"}}, required: ["id"], additionalProperties: false},
    source: "native",
    handler: async (args, app) => {
        const id = args.id as string | undefined;
...
registerCapability({
    id: "native/frontend/open_search",
    title: "Open search",
    description: "Open the KMG mobile search interface and optionally fill in a query.",
    inputSchema: {type: "object", properties: {query: {type: "string"}}, additionalProperties: false},
    source: "native",
    handler: async (args, app) => {
        const query = (args.query as string | undefined)?.trim();
